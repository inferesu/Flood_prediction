...
# --- Configuration ---
DATA_FILE            = 'vilnia_vilnius_complex_data_2024.csv'  # ← changed
STATION_CODE_HYDRO   = 'vilniaus-vilnia-vms'                   # ← changed
STATION_CODE_METEO_1 = 'vilniaus-ams'                          # ← changed
K_DECAY              = 0.85
...
def apply_hydrological_logic(df):
    ...
    # 5. S_t — seasonality cosine  (Eq. 11)
...
def main():
    ...
    print("=" * 60)
    print("   🌊 VILNIA–VILNIUS DATA PIPELINE")                    # ← changed
