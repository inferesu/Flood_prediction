...
MODEL_FILE    = 'kanalas_lankupiu_anfis_model_5d.pth'         # ← changed
SCALER_X_FILE = 'kanalas_lankupiu_scaler_X_5d.pkl'            # ← changed
SCALER_Y_FILE = 'kanalas_lankupiu_scaler_y_5d.pkl'            # ← changed
CONFIG_FILE   = 'kanalas_lankupiu_training_config_5d.json'    # ← changed
