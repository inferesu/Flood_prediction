...
MODEL_FILE    = 'lankupiu_minija_anfis_model_5d.pth'          # ← changed
SCALER_X_FILE = 'lankupiu_minija_scaler_X_5d.pkl'             # ← changed
SCALER_Y_FILE = 'lankupiu_minija_scaler_y_5d.pkl'             # ← changed
CONFIG_FILE   = 'lankupiu_minija_training_config_5d.json'     # ← changed
