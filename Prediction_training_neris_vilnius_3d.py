...
MODEL_FILE    = 'neris_vilnius_anfis_model_3d.pth'         # ← changed
SCALER_X_FILE = 'neris_vilnius_scaler_X_3d.pkl'            # ← changed
SCALER_Y_FILE = 'neris_vilnius_scaler_y_3d.pkl'            # ← changed
CONFIG_FILE   = 'neris_vilnius_training_config_3d.json'    # ← changed
