...
MODEL_FILE    = 'dane_kretinga_anfis_model_5d.pth'            # ← changed
SCALER_X_FILE = 'dane_kretinga_scaler_X_5d.pkl'               # ← changed
SCALER_Y_FILE = 'dane_kretinga_scaler_y_5d.pkl'               # ← changed
CONFIG_FILE   = 'dane_kretinga_training_config_5d.json'       # ← changed
