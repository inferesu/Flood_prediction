...
# ================= EVALUATION =================
print("\n--- SVR Evaluation (5D Delta-aligned) ---")
...
out_df.to_csv("svr_predictions_5d.csv", index=False)
print("\nSaved predictions to 'svr_predictions_5d.csv'.")

# ================= PLOT =================
plt.figure(figsize=(14,6))
plt.plot(wl_true,label="Actual WL (5 Days Ahead)")
plt.plot(wl_pred,'--', alpha=0.8, label="Predicted WL (5 Days Ahead)")
plt.title("SVR 5D Flood Prediction (Delta-aligned)")
plt.legend()
plt.grid(True)
plt.show()