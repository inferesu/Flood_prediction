...
MODEL_FILE    = 'nemunas_nemajunai_anfis_model_5d.pth'        # ← changed
SCALER_X_FILE = 'nemunas_nemajunai_scaler_X_5d.pkl'           # ← changed
SCALER_Y_FILE = 'nemunas_nemajunai_scaler_y_5d.pkl'           # ← changed
CONFIG_FILE   = 'nemunas_nemajunai_training_config_5d.json'   # ← changed
