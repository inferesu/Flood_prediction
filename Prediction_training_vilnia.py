...
MODEL_FILE    = 'vilnia_vilnius_anfis_model.pth'           # ← changed
SCALER_X_FILE = 'vilnia_vilnius_scaler_X.pkl'              # ← changed
SCALER_Y_FILE = 'vilnia_vilnius_scaler_y.pkl'              # ← changed
CONFIG_FILE   = 'vilnia_vilnius_training_config.json'      # ← changed
