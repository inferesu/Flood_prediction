...
MODEL_FILE    = 'nemunas_lampedziai_anfis_model.pth'           # ← changed
SCALER_X_FILE = 'nemunas_lampedziai_scaler_X.pkl'              # ← changed
SCALER_Y_FILE = 'nemunas_lampedziai_scaler_y.pkl'              # ← changed
CONFIG_FILE   = 'nemunas_lampedziai_training_config.json'      # ← changed
