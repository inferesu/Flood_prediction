...
# --- Configuration ---
DATA_FILE            = 'nemunas_nemajunai_complex_data_2024.csv'  # ← changed
STATION_CODE_HYDRO   = 'nemajunu-vms'                              # ← changed
STATION_CODE_METEO_1 = 'birstono-ams'                             # ← changed
STATION_CODE_METEO_2 = 'alytaus-ams'                              # ← changed
K_DECAY              = 0.85
...
def apply_hydrological_logic(df):
    ...
    avg_temp    = df[["temp_birstono-ams", "temp_alytaus-ams"]].mean(axis=1)   # ← changed
...
def main():
    ...
    print("=" * 60)
    print("   🌊 NEMUNAS–NEMAJŪNAI DATA PIPELINE")                  # ← changed
