...
MODEL_FILE    = 'lankupiu_minija_anfis_model_3d.pth'          # ← changed
SCALER_X_FILE = 'lankupiu_minija_scaler_X_3d.pkl'             # ← changed
SCALER_Y_FILE = 'lankupiu_minija_scaler_y_3d.pkl'             # ← changed
CONFIG_FILE   = 'lankupiu_minija_training_config_3d.json'     # ← changed
