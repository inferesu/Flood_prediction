...
def train_and_save():
    ...
    joblib.dump(scaler_X, "scaler_X_5d.pkl")
    joblib.dump(scaler_y, "scaler_y_5d.pkl")
    ...
    torch.save({'model_state_dict': model.state_dict(), 'coeff': model.coeff}, "anfis_model_5d.pth")
