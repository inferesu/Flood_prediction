...
MODEL_FILE    = 'nemunas_darsuniskis_anfis_model_5d.pth'       # ← changed
SCALER_X_FILE = 'nemunas_darsuniskis_scaler_X_5d.pkl'          # ← changed
SCALER_Y_FILE = 'nemunas_darsuniskis_scaler_y_5d.pkl'          # ← changed
CONFIG_FILE   = 'nemunas_darsuniskis_training_config_5d.json'  # ← changed
