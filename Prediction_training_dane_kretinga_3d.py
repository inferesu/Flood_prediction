...
MODEL_FILE    = 'dane_kretinga_anfis_model_3d.pth'            # ← changed
SCALER_X_FILE = 'dane_kretinga_scaler_X_3d.pkl'               # ← changed
SCALER_Y_FILE = 'dane_kretinga_scaler_y_3d.pkl'               # ← changed
CONFIG_FILE   = 'dane_kretinga_training_config_3d.json'       # ← changed
