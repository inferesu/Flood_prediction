...
MODEL_FILE    = 'kanalas_lankupiu_anfis_model_3d.pth'         # ← changed
SCALER_X_FILE = 'kanalas_lankupiu_scaler_X_3d.pkl'            # ← changed
SCALER_Y_FILE = 'kanalas_lankupiu_scaler_y_3d.pkl'            # ← changed
CONFIG_FILE   = 'kanalas_lankupiu_training_config_3d.json'    # ← changed
