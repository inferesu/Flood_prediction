...
MODEL_FILE    = 'kanalas_lankupiu_anfis_model.pth'            # ← changed
SCALER_X_FILE = 'kanalas_lankupiu_scaler_X.pkl'               # ← changed
SCALER_Y_FILE = 'kanalas_lankupiu_scaler_y.pkl'               # ← changed
CONFIG_FILE   = 'kanalas_lankupiu_training_config.json'       # ← changed
