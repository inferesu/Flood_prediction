...
MODEL_FILE    = 'marios_birstonas_anfis_model.pth'            # ← changed
SCALER_X_FILE = 'marios_birstonas_scaler_X.pkl'               # ← changed
SCALER_Y_FILE = 'marios_birstonas_scaler_y.pkl'               # ← changed
CONFIG_FILE   = 'marios_birstonas_training_config.json'       # ← changed
