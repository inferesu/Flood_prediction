...
MODEL_FILE    = 'marios_birstonas_anfis_model_5d.pth'         # ← changed
SCALER_X_FILE = 'marios_birstonas_scaler_X_5d.pkl'            # ← changed
SCALER_Y_FILE = 'marios_birstonas_scaler_y_5d.pkl'            # ← changed
CONFIG_FILE   = 'marios_birstonas_training_config_5d.json'    # ← changed
