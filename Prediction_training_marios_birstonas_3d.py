...
MODEL_FILE    = 'marios_birstonas_anfis_model_3d.pth'         # ← changed
SCALER_X_FILE = 'marios_birstonas_scaler_X_3d.pkl'            # ← changed
SCALER_Y_FILE = 'marios_birstonas_scaler_y_3d.pkl'            # ← changed
CONFIG_FILE   = 'marios_birstonas_training_config_3d.json'    # ← changed
