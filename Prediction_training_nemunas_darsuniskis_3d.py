...
MODEL_FILE    = 'nemunas_darsuniskis_anfis_model_3d.pth'       # ← changed
SCALER_X_FILE = 'nemunas_darsuniskis_scaler_X_3d.pkl'          # ← changed
SCALER_Y_FILE = 'nemunas_darsuniskis_scaler_y_3d.pkl'          # ← changed
CONFIG_FILE   = 'nemunas_darsuniskis_training_config_3d.json'  # ← changed
