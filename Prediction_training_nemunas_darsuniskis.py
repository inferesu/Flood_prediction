...
MODEL_FILE    = 'nemunas_darsuniskis_anfis_model.pth'
SCALER_X_FILE = 'nemunas_darsuniskis_scaler_X.pkl'            # ← fixed (removed "anfis_model_")
SCALER_Y_FILE = 'nemunas_darsuniskis_scaler_y.pkl'            # ← fixed
CONFIG_FILE   = 'nemunas_darsuniskis_training_config.json'    # ← fixed
