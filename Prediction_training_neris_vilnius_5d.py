...
MODEL_FILE    = 'neris_vilnius_anfis_model_5d.pth'         # ← changed
SCALER_X_FILE = 'neris_vilnius_scaler_X_5d.pkl'            # ← changed
SCALER_Y_FILE = 'neris_vilnius_scaler_y_5d.pkl'            # ← changed
CONFIG_FILE   = 'neris_vilnius_training_config_5d.json'    # ← changed
