...
MODEL_FILE    = 'lankupiu_minija_anfis_model.pth'             # ← changed
SCALER_X_FILE = 'lankupiu_minija_scaler_X.pkl'                # ← changed
SCALER_Y_FILE = 'lankupiu_minija_scaler_y.pkl'                # ← changed
CONFIG_FILE   = 'lankupiu_minija_training_config.json'        # ← changed
