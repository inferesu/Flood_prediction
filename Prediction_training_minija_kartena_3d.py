...
MODEL_FILE    = 'kartena_anfis_model_3d.pth'                  # ← changed
SCALER_X_FILE = 'kartena_scaler_X_3d.pkl'                     # ← changed
SCALER_Y_FILE = 'kartena_scaler_y_3d.pkl'                     # ← changed
CONFIG_FILE   = 'kartena_training_config_3d.json'             # ← changed
