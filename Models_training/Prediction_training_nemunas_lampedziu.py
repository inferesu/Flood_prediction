...
MODEL_FILE    = '../ANFIS_models/nemunas_lampedziai_anfis_model.pth'  # ← changed
SCALER_X_FILE = '../Scalers/nemunas_lampedziai_scaler_X.pkl'  # ← changed
SCALER_Y_FILE = '../Scalers/nemunas_lampedziai_scaler_y.pkl'  # ← changed
CONFIG_FILE   = '../Training_configs/nemunas_lampedziai_training_config.json'  # ← changed
...
def build_anfis(num_inputs: int, num_mfs: int) -> AnfisNet:
    ...
    return AnfisNet('Nemunas Lampedziai Flood Model', invardefs, ['y'], hybrid=True)  # ← changed
...
def train_and_save():
    print("=" * 60)
    print("   🌊 NEMUNAS–LAMPĖDŽIAI ANFIS TRAINING PIPELINE")      # ← changed
