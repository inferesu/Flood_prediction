...
MODEL_FILE    = '../ANFIS_models/nemunas_darsuniskis_anfis_model_5d.pth'  # ← changed
SCALER_X_FILE = '../Scalers/nemunas_darsuniskis_scaler_X_5d.pkl'  # ← changed
SCALER_Y_FILE = '../Scalers/nemunas_darsuniskis_scaler_y_5d.pkl'  # ← changed
CONFIG_FILE   = '../Training_configs/nemunas_darsuniskis_training_config_5d.json'  # ← changed
...
def build_anfis(num_inputs: int, num_mfs: int) -> AnfisNet:
    ...
    return AnfisNet('Nemunas Darsuniskis Flood Model 5D', invardefs, ['y'], hybrid=True)  # ← changed
...
def train_and_save():
    print("=" * 60)
    print("   🌊 NEMUNAS–DARSŪNIŠKIS ANFIS 5-DAY TRAINING PIPELINE")  # ← changed
