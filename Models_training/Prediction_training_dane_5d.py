...
MODEL_FILE    = '../ANFIS_models/dane_anfis_model_5d.pth'
SCALER_X_FILE = '../Scalers/dane_scaler_X_5d.pkl'
SCALER_Y_FILE = '../Scalers/dane_scaler_y_5d.pkl'
CONFIG_FILE   = '../Training_configs/dane_training_config_5d.json'
...
def build_anfis(num_inputs: int, num_mfs: int) -> AnfisNet:
    ...
    return AnfisNet('Dane Flood Model 5D', invardefs, ['y'], hybrid=True)
...
def train_and_save():
    print("=" * 60)
    print("   🌊 DANE ANFIS 5-DAY TRAINING PIPELINE")
