...
MODEL_FILE    = '../ANFIS_models/vilnia_vilnius_anfis_model.pth'  # ← changed
SCALER_X_FILE = '../Scalers/vilnia_vilnius_scaler_X.pkl'  # ← changed
SCALER_Y_FILE = '../Scalers/vilnia_vilnius_scaler_y.pkl'  # ← changed
CONFIG_FILE   = '../Training_configs/vilnia_vilnius_training_config.json'  # ← changed
...
def build_anfis(num_inputs: int, num_mfs: int) -> AnfisNet:
    ...
    return AnfisNet('Vilnia Vilnius Flood Model', invardefs, ['y'], hybrid=True)  # ← changed
...
def train_and_save():
    print("=" * 60)
    print("   🌊 VILNIA–VILNIUS ANFIS TRAINING PIPELINE")           # ← changed
