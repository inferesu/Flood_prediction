...
MODEL_FILE    = '../ANFIS_models/neris_vilnius_anfis_model_3d.pth'  # ← changed
SCALER_X_FILE = '../Scalers/neris_vilnius_scaler_X_3d.pkl'  # ← changed
SCALER_Y_FILE = '../Scalers/neris_vilnius_scaler_y_3d.pkl'  # ← changed
CONFIG_FILE   = '../Training_configs/neris_vilnius_training_config_3d.json'  # ← changed
...
def build_anfis(num_inputs: int, num_mfs: int) -> AnfisNet:
    ...
    return AnfisNet('Neris Vilnius Flood Model 3D', invardefs, ['y'], hybrid=True)  # ← changed
...
def train_and_save():
    print("=" * 60)
    print("   🌊 NERIS–VILNIUS ANFIS 3-DAY TRAINING PIPELINE")     # ← changed
