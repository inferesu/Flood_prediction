...
MODEL_FILE    = '../ANFIS_models/nemunas_nemajunai_anfis_model_3d.pth'  # ← changed
SCALER_X_FILE = '../Scalers/nemunas_nemajunai_scaler_X_3d.pkl'  # ← changed
SCALER_Y_FILE = '../Scalers/nemunas_nemajunai_scaler_y_3d.pkl'  # ← changed
CONFIG_FILE   = '../Training_configs/nemunas_nemajunai_training_config_3d.json'  # ← changed
...
def prepare_complex_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Average across both meteo stations
...
def build_anfis(num_inputs: int, num_mfs: int) -> AnfisNet:
    ...
    return AnfisNet('Nemunas Nemajunai Flood Model 3D', invardefs, ['y'], hybrid=True)  # ← changed
...
def train_and_save():
    print("=" * 60)
    print("   🌊 NEMUNAS–NEMAJŪNAI ANFIS 3-DAY TRAINING PIPELINE")  # ← changed
