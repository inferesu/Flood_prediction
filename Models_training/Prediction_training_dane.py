...
MODEL_FILE    = '../ANFIS_models/dane_anfis_model.pth'
SCALER_X_FILE = '../Scalers/dane_scaler_X.pkl'
SCALER_Y_FILE = '../Scalers/dane_scaler_y.pkl'
CONFIG_FILE   = '../Training_configs/dane_training_config.json'
