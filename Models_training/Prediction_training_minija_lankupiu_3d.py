...
TRAIN_DATA_FILE = '../minija_lankupiu_complex_data_2024.csv'  # ← changed
FEATURES_LIST   = ['API_norm', 'S_t', 'SMI_t', 'Pt', 'delta_WL_t']
TARGET          = 'target_change_3d'

MODEL_FILE    = '../ANFIS_models/lankupiu_minija_anfis_model_3d.pth'  # ← changed
SCALER_X_FILE = '../Scalers/lankupiu_minija_scaler_X_3d.pkl'  # ← changed
SCALER_Y_FILE = '../Scalers/lankupiu_minija_scaler_y_3d.pkl'  # ← changed
CONFIG_FILE   = '../Training_configs/lankupiu_minija_training_config_3d.json'  # ← changed
...
def build_anfis(num_inputs: int, num_mfs: int) -> AnfisNet:
    ...
    return AnfisNet('Lankupiu Minija Flood Model 3D', invardefs, ['y'], hybrid=True)  # ← changed
...
def train_and_save():
    print("=" * 60)
    print("   🌊 LANKUPIAI–MINIJA ANFIS 3-DAY TRAINING PIPELINE")  # ← changed
