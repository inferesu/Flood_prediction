...
MODEL_FILE    = '../ANFIS_models/marios_birstonas_anfis_model.pth'  # ← changed
SCALER_X_FILE = '../Scalers/marios_birstonas_scaler_X.pkl'  # ← changed
SCALER_Y_FILE = '../Scalers/marios_birstonas_scaler_y.pkl'  # ← changed
CONFIG_FILE   = '../Training_configs/marios_birstonas_training_config.json'  # ← changed
...
def build_anfis(num_inputs: int, num_mfs: int) -> AnfisNet:
    ...
    return AnfisNet('Marios Birstonas Flood Model', invardefs, ['y'], hybrid=True)  # ← changed
...
def train_and_save():
    print("=" * 60)
    print("   🌊 MARIOS–BIRŠTONAS ANFIS TRAINING PIPELINE")         # ← changed
