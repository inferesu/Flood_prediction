...
MODEL_FILE    = '../ANFIS_models/dane_anfis_model_3d.pth'
SCALER_X_FILE = '../Scalers/dane_scaler_X_3d.pkl'
SCALER_Y_FILE = '../Scalers/dane_scaler_y_3d.pkl'
CONFIG_FILE   = '../Training_configs/dane_training_config_3d.json'


# ---------------------------------------------------------------------------
# Feature engineering  — single station (klaipedos-ams only)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Model factory  — stable initialisation, no random a/c
# ---------------------------------------------------------------------------
def build_anfis(num_inputs: int, num_mfs: int) -> AnfisNet:
        ...
        (
            ...
            [
                BellMembFunc(
                    ...
                    centres[j].unsqueeze(0),    # c — evenly spaced
                )
    ...
    return AnfisNet('Dane Flood Model 3D', invardefs, ['y'], hybrid=True)
...
def train_and_save():
    print("=" * 60)
    print("   🌊 DANE ANFIS 3-DAY TRAINING PIPELINE")
    print(f"   Input  : {TRAIN_DATA_FILE}")
    print(f"   Model  : {MODEL_FILE}")
    print(f"   Station: klaipedos-ams only")
    print(f"   LR     : {LR}")
    print("=" * 60)
