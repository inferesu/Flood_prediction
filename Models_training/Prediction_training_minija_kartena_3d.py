...
MODEL_FILE    = '../ANFIS_models/kartena_anfis_model_3d.pth'  # ← changed
SCALER_X_FILE = '../Scalers/kartena_scaler_X_3d.pkl'  # ← changed
SCALER_Y_FILE = '../Scalers/kartena_scaler_y_3d.pkl'  # ← changed
CONFIG_FILE   = '../Training_configs/kartena_training_config_3d.json'  # ← changed
...
def build_anfis(num_inputs: int, num_mfs: int) -> AnfisNet:
    ...
    return AnfisNet('Kartena Flood Model 3D', invardefs, ['y'], hybrid=True)       # ← changed
...
def train_and_save():
    print("=" * 60)
    print("   🌊 MINIJA–KARTENA ANFIS 3-DAY TRAINING PIPELINE")   # ← changed
