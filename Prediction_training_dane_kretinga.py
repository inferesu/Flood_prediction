...
MODEL_FILE    = 'dane_kretinga_anfis_model.pth'           # ← changed
SCALER_X_FILE = 'dane_kretinga_scaler_X.pkl'              # ← changed
SCALER_Y_FILE = 'dane_kretinga_scaler_y.pkl'              # ← changed
CONFIG_FILE   = 'dane_kretinga_training_config.json'      # ← changed
