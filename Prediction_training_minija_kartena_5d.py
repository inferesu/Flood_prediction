...
MODEL_FILE    = 'kartena_anfis_model_5d.pth'                  # ← changed
SCALER_X_FILE = 'kartena_scaler_X_5d.pkl'                     # ← changed
SCALER_Y_FILE = 'kartena_scaler_y_5d.pkl'                     # ← changed
CONFIG_FILE   = 'kartena_training_config_5d.json'             # ← changed
