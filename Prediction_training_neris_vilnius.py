...
MODEL_FILE    = 'neris_vilnius_anfis_model.pth'            # ← changed
SCALER_X_FILE = 'neris_vilnius_scaler_X.pkl'               # ← changed
SCALER_Y_FILE = 'neris_vilnius_scaler_y.pkl'               # ← changed
CONFIG_FILE   = 'neris_vilnius_training_config.json'       # ← changed
