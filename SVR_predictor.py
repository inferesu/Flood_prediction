...
# ================= CONFIG =================
LOOK_BACK_PERIOD = 14  # Synced to 14 to match LSTM & XGBoost comparisons
...
def create_flat_sequences(X, y, look_back):
    ...
    for i in range(len(X) - look_back):
        # Flatten the 2D sequence window into a 1D array for SVR
...
plt.title("SVR Prediction of Water Level (Delta-aligned)")
plt.legend()
plt.grid(True)
plt.show()