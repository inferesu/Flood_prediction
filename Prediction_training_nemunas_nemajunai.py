...
MODEL_FILE    = 'nemunas_nemajunai_anfis_model.pth'           # ← changed
SCALER_X_FILE = 'nemunas_nemajunai_scaler_X.pkl'              # ← changed
SCALER_Y_FILE = 'nemunas_nemajunai_scaler_y.pkl'              # ← changed
CONFIG_FILE   = 'nemunas_nemajunai_training_config.json'      # ← changed
